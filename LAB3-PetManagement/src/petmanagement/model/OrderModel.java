 ...
 * @author leyen
 */
public class OrderModel implements PetStoreModelInterface, Comparable<OrderModel> {

    public static String CUSTOMER_NAME_PATTERN = "[a-zA-Z]{5-30}";
    public static String ORDER_ID_FORMAT = "OXXX";
    ...
    public OrderModel(String orderID, Date orderDate, String customer, List<OrderLine> orderList) {
...
//    }
    ...
    public double getTotal() {
        ...
        for (OrderLine order : orderList) {
            total += order.getQuantity() * order.getPet().getPrice();
        }
        return total;
    }
    ...
    public int compareTo(OrderModel o) {
        return this.orderID.compareTo(o.getId());
    }
